...
type PromoCodeUsage struct {
	...
	Customer  *Customer  `gorm:"foreignKey:UserID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" redis:"-"`
	Order     *Order     `gorm:"foreignKey:OrderID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" redis:"-"`
}
