...
type Order struct {
	...
	UserID            uint32    `json:"user_id" gorm:"index;not null" redis:"user_id"`
	...
	BillingAddressID  uint32    `json:"billing_address_id" gorm:"index;not null" redis:"billing_address_id"`
	ShippingAddressID uint32    `json:"shipping_address_id" gorm:"index;not null" redis:"shipping_address_id"`
	PaymentID         uint32    `json:"payment_id" gorm:"index;not null" redis:"payment_id"`
}
